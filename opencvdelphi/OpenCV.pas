...
{$endif}  
{$ifdef FPC}
  {$ifdef MSEGUI} // use MseGUI package
...
{$ifdef MSWINDOWS} 
{$ifdef V2}
 cvDLL       = 'opencv_imgproc243.dll';
 videoDLL    = 'opencv_video243.dll';
 calibDLL    = 'opencv_calib3d243.dll';
 HighGUI_DLL = 'opencv_highgui243.dll';
 cxCore      = 'opencv_core243.dll';
{$else}
 cvDLL       = 'CV100.DLL';
 videoDLL    = 'CV100.DLL';
 calibDLL    = 'CV100.DLL';
